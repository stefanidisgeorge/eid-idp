...
public class ProtocolServiceManagerBean implements ProtocolServiceManager {
    ...
    public List<IdentityProviderProtocolType> getProtocolServices() {
        ...
        while (resources.hasMoreElements()) {
            ...
            IdentityProviderProtocolsType identityProviderProtocols =
                    jaxbElement.getValue();
            for (IdentityProviderProtocolType identityProviderProtocol :
                    identityProviderProtocols.getIdentityProviderProtocol()) {
