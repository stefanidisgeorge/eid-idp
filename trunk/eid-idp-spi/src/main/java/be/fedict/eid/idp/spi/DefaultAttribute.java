...
public enum DefaultAttribute {
        ...
        GENDER(
                "Gender",
                "Gender of a Subject that can have any of these exact string values Ð '0' (meaning unspecified), '1' (meaning Male) or '2' (meaning Female). Using these values allows them to be language neutral.",
