...
public class ProtocolEntryServlet extends HttpServlet {
        ...
        try {
            ...
            if (null != incomingRequest.getRequiredAttributes() &&
                ...
                for (String attributeProtocolUri : incomingRequest.getRequiredAttributes()) {
                    ...
                    // lookup attribute
                    AttributeEntity attribute = this.attributeService.findAttribute(
                            protocolService.getId(), attributeProtocolUri);
    ...
    private void redirectToErrorPage(String errorMessage,
        ...
        httpSession.setAttribute(
                this.protocolErrorMessageSessionAttributeInitParam, errorMessage);
        response.sendRedirect(request.getContextPath()
