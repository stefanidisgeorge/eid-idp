...
public class AuthenticationResponseProcessorTest {
        ...
        private static final Log LOG =
                LogFactory.getLog(AuthenticationResponseProcessorTest.class);
        ...
        public void testPostSamlResponseFailedStatus() throws Exception {
                ...
                new ProcessingFailTest() {
                        ...
                        @Override
                        protected void modifyResponse(Response response) {
                                response.getStatus().getStatusCode().setValue(
        ...
        @Test
        public void testPostSamlResponseMissingSubjectConfirmation() throws Exception {
        ...
        @Test
        public void testPostSamlResponseWrongSubjectConfirmationMethod() throws Exception {
        ...
        @Test
        public void testPostSamlResponseWrongSubjectConfirmationDataInResponseTo() throws Exception {
        ...
        @Test
        public void testPostSamlResponseWrongSubjectConfirmationDataRecipient() throws Exception {
        ...
        @Test
        public void testPostSamlResponseWrongSubjectConfirmationDataTime() throws Exception {
        ...
        public void testPostSamlResponseNoOneTimeUse() throws Exception {
                ...
                new ProcessingFailTest() {
                        ...
                        protected void modifyResponse(Response response) {
                                ...
                                QName oneTimeUseQName = new QName(
                                        SAMLConstants.SAML20_NS,
                                        OneTimeUse.DEFAULT_ELEMENT_LOCAL_NAME,
                                        SAMLConstants.SAML20_PREFIX);

                                List oneTimeUseList =
                                        ((IndexedXMLObjectChildrenList) (response.getAssertions().get(0)
                                                .getConditions()
                                                .getConditions())).subList(oneTimeUseQName);

                                response.getAssertions().get(0).getConditions()
                                        .getConditions().remove(oneTimeUseList.get(0));
                        }
                }.doTest();
        }
