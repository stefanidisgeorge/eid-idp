...
<html>
    ...
    <body>
        ...
        <p>This test Service Provider (SP) demos the different
            identification/authentication protocols towards the eID IdP.
        </p>
        <ul>
            <li>
                <a href="https://<%=request.getServerName()%>:<%=request.getServerPort()%>/eid-idp/protocol/foobar">
        ...
        <ul>
            <li>
                <a href="saml2/post/ident.jsp">Identification</a>
            </li>
            <li>
                <a href="saml2/post/auth.jsp">Authentication</a>
            </li>
            <li>
                <a href="saml2/post/auth-ident.jsp">Authentication +
                    Identification
                </a>
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                <a href="saml2/artifact/ident.jsp">Identification</a>
            </li>
            <li>
                <a href="saml2/artifact/auth.jsp">Authentication</a>
            </li>
            <li>
                <a href="saml2/artifact/auth-ident.jsp">Authentication +
                    Identification
                </a>
            </li>
        </ul>
